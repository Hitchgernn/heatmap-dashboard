...
export default function SettingsView({
  ...
  return (
    <div className="flex flex-col">
      ...
      <footer className="border-t border-gray-100 px-6 py-4 dark:border-gray-800">
        <button
          type="button"
          onClick={onLogout}
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm font-semibold text-red-600 transition-colors hover:bg-red-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400 dark:border-red-900/60 dark:bg-gray-900 dark:text-red-400 dark:hover:bg-red-950/40"
        >
          {LOGOUT}
          {t("settings.logout")}
        </button>
