...
export default function ActiveIndicator({ label, color = "#10b981" }: ActiveIndicatorProps) {
  return (
    <span className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-gray-700 shadow-sm">
